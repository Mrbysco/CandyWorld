...
public class GummyBearRenderer extends MobRenderer<GummyBearEntity, GummyBearModel<GummyBearEntity>> {
    private static final Map<EnumGummy, ResourceLocation> GUMMY_BEAR_TEXTURES = Util.make(Maps.newEnumMap(EnumGummy.class), (location) -> {
        location.put(EnumGummy.RED, new ResourceLocation(com.mrbysco.candyworld.CandyWorld.MOD_ID, "textures/entity/gummy_bear/red_gummy_bear.png"));
        location.put(EnumGummy.ORANGE, new ResourceLocation(com.mrbysco.candyworld.CandyWorld.MOD_ID, "textures/entity/gummy_bear/orange_gummy_bear.png"));
        location.put(EnumGummy.YELLOW, new ResourceLocation(com.mrbysco.candyworld.CandyWorld.MOD_ID, "textures/entity/gummy_bear/yellow_gummy_bear.png"));
        location.put(EnumGummy.WHITE, new ResourceLocation(com.mrbysco.candyworld.CandyWorld.MOD_ID, "textures/entity/gummy_bear/white_gummy_bear.png"));
        location.put(EnumGummy.GREEN, new ResourceLocation(com.mrbysco.candyworld.CandyWorld.MOD_ID, "textures/entity/gummy_bear/green_gummy_bear.png"));
    });
